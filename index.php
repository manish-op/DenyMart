...
<body>
        ...
        <div class="container">
            <div class="navbar">
                ...
                <nav>
                    <ul id="MenuItems">
                        ...
                        <li><a href="categories.html" class="">Categories</a></li>
                        
                        <li><a href="sign_up.php" class="">Login/Sign up</a></li>
                ...
                <h3 style="font-family:'Segoe UI"> </h3>
            ...
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <a href='sign_up.php' class="btn">Explore &#8594</a>
        ...
        <div class="small-container">
            <div class="row">
                ...
                <div class="col-3">
                    ...
                    <img src="images/category-1.jpg" alt='catg1' />
                ...
                <div class="col-3">
                    ...
                    <img src="images/tshirt1.jpg" alt='category-4' />
                ...
                <div class="col-3">
                    ...
                    <img src="images/tshirt2.jpg" alt='category-5' />
                ...
                <div class="col-3">
                    ...
                    <img src="images/tshirt3.jpg" alt='category-6' />
    ...
    <div class="small-container">
        ...
        <div class="row">
            ...
            <div class="col-4">
                <a href="blacktshirt1.html"> <img src="images/puma-t1.jpeg" alt='img'></a>
                <h4>Black T-Shirt</h4>
                <div class="ratings">
            ...
            <div class="col-4">
                <a href="shoe1.html"><img src="images/product-nike1.jpg" alt='img'></a>
            ...
            <div class="col-4">
                <a href="track_pant1.html"><img src="images/product-3.jpg" alt='product-3'></a>
                <h4>Track Pants</h4>
                <div class="ratings">
        ...
        <div class="small-container">
            <div class="row">
                ...
                <div class="col-2">
                    ...
                    <a href="sign_up.php" class="btn">Buy Now &#8594</a>
                </div>
            </div>
        </div>
    </div>
